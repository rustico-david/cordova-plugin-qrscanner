...
class QRScanner : CDVPlugin, AVCaptureMetadataOutputObjectsDelegate {
    ...
    func prepScanner(command: CDVInvokedUrlCommand) -> Bool{
        ...
        do {
            if (captureSession?.isRunning != true){
                ...
                metaOutput!.metadataObjectTypes = [AVMetadataObjectTypeQRCode, AVMetadataObjectTypeInterleaved2of5Code, AVMetadataObjectTypeCode128Code]
    ...
    func captureOutput(_ captureOutput: AVCaptureOutput!, didOutputMetadataObjects metadataObjects: [Any]!, from connection: AVCaptureConnection!) {
        ...
        if (found.type == AVMetadataObjectTypeQRCode || found.type == AVMetadataObjectTypeInterleaved2of5Code || found.type == AVMetadataObjectTypeCode128Code) && found.stringValue != nil {
            scanning = false
